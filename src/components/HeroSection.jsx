...
function HeroSection() {
    return (
        <>
            <div className=' container flex justify-center mt-6 m-auto bg-cover bg-center bg-no-repeat w-full h-[75vh]' style={{ backgroundImage: `url(${Hero})` }}>
                <div className='flex flex-col text-center items-center' >
                    <h2 className='gray font-semibold mt-28'>COMPARISONS</h2>
                    <h1 className='text-[#13171F] mt-2 text-7xl font-financier max-w-[916px]' >How does Copperx <span className=' text-[#4C63ED]'>compare </span>to the competition?</h1>
